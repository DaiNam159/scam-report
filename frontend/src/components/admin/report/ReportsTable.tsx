...
//                 <th
//                   key={col.key}
//                   className="px-6 py-3 font-semibold text-gray-900 uppercase text-xs border-b border-blue-200 w-[120px] min-w-[120px] max-w-[140px] text-center"
//                 >
//                   {col.label}
//                 </th>
//               ) : (
...
//               } hover:bg-blue-100`}
//             >
//               <td className="sticky left-0 z-0 px-6 py-4 font-medium text-gray-900 bg-white border-b whitespace-nowrap border-blue-50">
//                 #{report.id}
//               </td>
//               <td className="px-6 py-4 text-gray-900 border-b border-blue-50">
//                 <div className="max-w-xs font-medium truncate">
//                   {report.title}
//                 </div>
//               </td>
//               <td className="px-6 py-4 border-b border-blue-50 whitespace-nowrap">
...
//               </td>
//               <td className="px-6 py-4 text-gray-900 border-b border-blue-50 whitespace-nowrap">
//                 {formatDate(report.created_at)}
//               </td>
//               <td className="px-6 py-2 border-b border-blue-50 whitespace-nowrap w-[120px] min-w-[120px] max-w-[140px] text-center">
//                 <div className="flex flex-row flex-wrap items-center justify-center gap-1">
//                   <button
//                     onClick={() => onView(report)}
//                     title="Xem chi tiết"
//                     className="flex items-center justify-center text-blue-700 transition border border-blue-100 rounded-full w-7 h-7 bg-blue-50 hover:bg-blue-100"
//                   >
//                     <FaEye className="w-4 h-4" />
//                   </button>

//                   {/* Luôn hiển thị button duyệt nhưng disable khi không phải PENDING */}
//                   <button
//                     onClick={() =>
...
//                     className={`flex items-center justify-center transition border rounded-full w-7 h-7 ${
//                       report.status === ReportStatus.PENDING
//                         ? "text-green-700 border-green-100 bg-green-50 hover:bg-green-100"
//                         : report.status === ReportStatus.APPROVED
//                         ? "text-green-500 border-green-200 bg-green-50 cursor-not-allowed"
...
//                   {/* Luôn hiển thị button từ chối nhưng disable khi không phải PENDING */}
//                   <button
//                     onClick={() =>
...
//                     className={`flex items-center justify-center transition border rounded-full w-7 h-7 ${
//                       report.status === ReportStatus.PENDING
//                         ? "text-red-700 border-red-100 bg-red-50 hover:bg-red-100"
//                         : report.status === ReportStatus.REJECTED
//                         ? "text-red-500 border-red-200 bg-red-50 cursor-not-allowed"
//                         : "text-gray-400 border-gray-200 bg-gray-50 cursor-not-allowed"
//                     }`}
//                   >
...
//                     title="Xóa"
//                     className="flex items-center justify-center text-red-700 transition border border-red-100 rounded-full w-7 h-7 bg-red-50 hover:bg-red-100"
//                   >
